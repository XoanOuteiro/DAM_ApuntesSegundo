...
public class Controller {
    ...
    private DLOHandler<Paciente> fhandle;

    private String fileURL = "files/savestate.txt";

    //Builder methods
    public Controller() throws IOException {

        this.fhandle = new DLOHandler<Paciente>(this.fileURL);
    ...
    public void insert() throws InputMismatchException {
        ...
        try {
            ...
            throw new InputMismatchException("Input error, please try again after checking type needs on PDF.");
