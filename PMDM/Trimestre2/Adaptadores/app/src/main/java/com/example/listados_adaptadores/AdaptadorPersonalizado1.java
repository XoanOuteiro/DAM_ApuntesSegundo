...
public class AdaptadorPersonalizado1 extends ArrayAdapter {
    ...
    public AdaptadorPersonalizado1(@NonNull Activity context, int layout_personalizado, String[] arrayPlanetas, int[] arrayIdFotos) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        imgPlanetas.setImageResource(arrayIdFotos[position]);
